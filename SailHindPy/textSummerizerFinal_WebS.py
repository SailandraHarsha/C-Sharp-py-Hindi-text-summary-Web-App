...
class summarizationHi:
	def POST(self):
		...
		ActFilePath = data['ActFilePath']
		StopWordFile = data['StopWordFile']
		SummPer = data['SummPer']
		OutFile = data['OutFile']

		#print(input_text)
	
		# for reading input file
		text = open(ActFilePath, encoding="utf8").read()
		...
		# print(tokens)
		stop_removed_tokens = []
		f = open(StopWordFile, encoding="utf8")
		...
		def sentence_length(sentences):
			...
			MaxL = 25  # maxm len of sentence default was 18
		...
		encoding = 'utf8'
		file = open(OutFile,"w", encoding=encoding) 
